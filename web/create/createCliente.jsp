<%-- 
    ...
    Created on : 25/11/2022, 3:42:37 p. m.
    Author     : Nova
--%>
...
<html lang="es">
    <head>
        ...
        <title>SearchMe - Crear Cliente</title>
        <meta name="viewport"
    ...
    <body>
        ...
        <div class="contenedor-contenido">
            <p>Bienvenido al panel de registro de clientes. Aquí podrá establecer la información respectivamente, por favor ingrese los datos y haga clic en crear.</p>
            <form class="formulario" action="/SearchMeWebApp/ClientesController" method="post">
                ...
                <input type="text" maxlength="15" placeholder="Segundo Nombre" name="sdNombre" value="" autocomplete="off">
