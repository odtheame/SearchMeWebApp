<%-- 
    Document   : editTienda
    Created on : 25/11/2022, 8:11:50 p. m.
    Author     : Nova
--%>
...
<html lang="es">
    <head>
        ...
        <title>SearchMe - Editar Tienda</title>
        <meta name="viewport"
    ...
    <body>
        ...
        <%
            String nombre, direccion, telefono, idBodega;
        ...
        <div class="contenedor-contenido">
            <p>Bienvenido al panel de creación de una tienda. Aquí podrá establecer la información respectivamente, por favor ingrese los datos si es el caso y haga clic en actualizar o eliminar.</p>
